...
function verifyExistsAccountCPF(request, response, next){
    ...
    //precisa retornr infomação completa, some retorna true false
...
app.post("/account", (request, response) => {
    ...
    //se não existir outro cpf ele pula pra esse passo
    customers.push({
        cpf,
        name,
        id: uuidv4(),
...
// duas formas de chamar midlerare, direto na requisição entre a bara e o requeste e assim:
